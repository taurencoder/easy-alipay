...
module.exports = {
  ...
  Notification: {
    directPayNotify: function(notification, partnerId) {
      return alipayNotify.verifyNotification(notification, partnerId, defaultConfig.accessData);
    },

    directPayNotifyWap: function(notification, partnerId) {
      ...
      .then(function(res) {
        ...
        return alipayNotify.verifyNotificationWap(notification, partnerId, defaultConfig.accessData);
      });
    }
  }
};
